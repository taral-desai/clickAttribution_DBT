...
- `click` - Delta table appended by Spark batch process daily, refered as external table in Redshift
- `checkout` - Delta table appended by Spark batch process daily, refered as external table in Redshift
